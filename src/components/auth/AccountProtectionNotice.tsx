...
export function AccountProtectionNotice() {
  return (
    ...
    >
      <p className="text-[10px] uppercase tracking-[0.3em] text-[hsl(var(--brand-gold))]">
      ...
      <Link
        ...
        className="mt-4 inline-flex text-xs uppercase tracking-[0.15em] text-[hsl(var(--brand-gold))] underline-offset-4 hover:underline"
      >
