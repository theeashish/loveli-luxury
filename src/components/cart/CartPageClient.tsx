      ...
      {lines.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_22rem]">
          ...
          <aside className="self-start rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--muted))] p-6">
            ...
            <Link
              href="/checkout"
              className="mt-6 block w-full rounded-md bg-[hsl(var(--foreground))] px-6 py-3 text-center text-sm font-medium uppercase tracking-[0.15em] text-[hsl(var(--background))]"
            >
