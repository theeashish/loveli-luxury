...
const STATS = [
  { v: '4', l: 'Partner tiers' },
  { v: '10–20%', l: 'Direct commission' },
  { v: 'Quarterly', l: 'Retention reviews' },
    ...
    <section className="relative overflow-hidden border-t border-[hsl(var(--border))]/60 py-24">
      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-[hsl(var(--muted-foreground))]">
          Invite-only. Four tiers, each tied to verified retail performance.
          Begin as a Concierge Partner with 10% on direct sales and progress
          through Brand Associate, Regional Curator, and Prestige Partner —
          richer earnings, regional access, limited-edition allocation.
          Retention bonuses reviewed quarterly, tied to real sales.
        </p>
