    ...
    <section className="relative isolate overflow-hidden bg-[hsl(37_42%_90%)] text-[hsl(22_18%_12%)]">
      ...
      <div className="relative mx-auto grid min-h-[30rem] max-w-7xl grid-cols-1 lg:min-h-[37rem] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="loveli-reveal-up relative z-10 flex flex-col justify-center px-6 py-14 sm:py-18 lg:px-10 lg:py-20">
          <p className="text-[10px] font-semibold uppercase tracking-[0.34em] text-[hsl(35_45%_42%)]">{copy.eyebrow}</p>
          ...
          <p className="mt-7 max-w-md text-base leading-8 text-[hsl(22_12%_28%)] sm:text-lg">{copy.subhead}</p>
          <div className="mt-8 flex flex-wrap items-center gap-5">
            <Link href={copy.ctaHref} className="inline-flex items-center justify-center bg-[hsl(22_18%_10%)] px-8 py-4 text-[10px] font-semibold uppercase tracking-[0.28em] text-[hsl(38_52%_87%)] transition duration-200 hover:-translate-y-0.5 hover:bg-[hsl(35_45%_42%)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(35_45%_42%)] focus-visible:ring-offset-2">{copy.ctaLabel}</Link>
            <div className="min-w-[10rem] border-l border-[hsl(35_45%_42%/0.35)] pl-5">
              <p className="text-[9px] font-semibold uppercase tracking-[0.24em] text-[hsl(35_45%_42%)]">{copy.rotatingLabel}</p>
        ...
        <div className="loveli-reveal-up relative min-h-[21rem] overflow-hidden sm:min-h-[27rem] lg:min-h-[37rem]">
          <div aria-hidden className="loveli-float absolute inset-x-[12%] bottom-[9%] h-16 rounded-[50%] bg-[hsl(22_18%_12%/0.18)] blur-2xl" />
          ...
          <p className="absolute bottom-[5%] right-[10%] text-[9px] font-semibold uppercase tracking-[0.32em] text-[hsl(35_45%_42%)]">Loveli Luxury Scents</p>
        </div>
      </div>
    </section>
  )
