  ...
  public: {
    Tables: {
      ...
      internal_pv_allocations: {
        ...
        Relationships: [
          {
            foreignKeyName: "internal_pv_allocations_source_order_id_fkey";
            columns: ["source_order_id"];
            isOneToOne: false;
            referencedRelation: "orders";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "internal_pv_allocations_source_order_item_id_fkey";
          ...
          {
            foreignKeyName: "internal_pv_allocations_variant_id_fkey";
            columns: ["variant_id"];
            isOneToOne: false;
            referencedRelation: "product_variants";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      record_internal_pv_allocations: {
