...
<div style="font-family:Georgia,'Times New Roman',serif;color:#121212;max-width:560px;margin:0 auto;padding:32px 24px">
  <p style="letter-spacing:.3em;text-transform:uppercase;font-size:11px;color:#121212;margin:0 0 8px">Loveli Luxury</p>
  ...
  <p style="margin:20px 0 8px;font-size:14px">Track your order: <a href="${trackUrl}" style="color:#121212">${escapeHtml(data.orderNumber)}</a></p>
