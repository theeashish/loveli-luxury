...
const NAV = [
  { href: '/admin/diagnostics', label: 'Live checks' },
] as const
  ...
  return (
    <div className="grid min-h-screen grid-cols-[16rem_1fr] bg-neutral-50">
      <aside className="border-r border-neutral-200 bg-white p-6">
        <div className="mb-8">
          <Link href="/admin/diagnostics" className="text-lg font-semibold tracking-tight">
            Loveli — diagnostics
          </Link>
        ...
        <nav className="flex flex-col gap-1 text-xs uppercase tracking-[0.15em] text-neutral-500">
          ...
          <Link href="/admin/close" className="rounded px-3 py-2 hover:bg-neutral-100">
            Close
          </Link>
        </nav>
      </aside>
